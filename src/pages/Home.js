    ...
    <div className="home-page">
        <div className="home-page-body">
            ...
            <div className="welcome-note">
                ...
                <p>It was confusing, tiring and fustrating I'll honest, but I trust the process and didn't giving up on myself and keep learning new stuff.</p>
                <p>I have my inspiration from my dad who work in investments and digital assets along with his own company in real estate industry which make me want to explore more in business field not only stay in tech.</p>
